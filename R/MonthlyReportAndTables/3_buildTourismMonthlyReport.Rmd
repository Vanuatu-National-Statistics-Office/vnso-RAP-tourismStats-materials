...
```{r visits_over_time, fig.height=5, fig.width = 15}
...
```{r visit_reasons, warning=FALSE, fig.width=5.5, fig.height=2.5}
...
```{r originating_country, warning=FALSE, fig.width=5.5, fig.height=2.5}
...
```{r age_country_residence, warning=FALSE, fig.width=5.5, fig.height=2.5}
...
```{r visit_reasons_graphic, warning=FALSE, fig.width=5.5, fig.height=2.5}
...
```{r prop_outer_islands, warning=FALSE, fig.width=5.5, fig.height=2.5}
